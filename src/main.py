...
app.include_router(catalog.router, prefix=f"{api_version_prefix}/cinema", tags=["cinema"])
app.include_router(moderator.router, prefix=f"{api_version_prefix}/cinema", tags=["cinema"])
...
app.include_router(ratings.router, prefix=f"{api_version_prefix}/cinema/movies", tags=["ratings"])
